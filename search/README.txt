The Search project contains the web site that serves as the entry point 
for the search components. It also includes the POM that should be 
inherited by all of the search projects. The site should be online at 
http://pds-cm.jpl.nasa.gov/pds4/search/. If it is not accessible, you can 

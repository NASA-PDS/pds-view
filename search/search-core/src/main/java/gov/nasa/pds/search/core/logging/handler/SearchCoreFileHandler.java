...
//
// $Id: HarvestFileHandler.java 7917 2010-10-21 21:03:42Z mcayanan $
package gov.nasa.pds.search.core.logging.handler;

import gov.nasa.pds.search.core.logging.filter.ToolsLogFilter;
 ...
 *
 */
public class SearchCoreFileHandler extends FileHandler {
     ...
     * @throws IOException
     */
    public SearchCoreFileHandler(String file, Formatter formatter)
     ...
     * @throws IOException
     */
    public SearchCoreFileHandler(String file, Level level, Formatter formatter)
    throws SecurityException, IOException {
     ...
     * @throws IOException
     */
    public SearchCoreFileHandler(String file, boolean append, Level level,

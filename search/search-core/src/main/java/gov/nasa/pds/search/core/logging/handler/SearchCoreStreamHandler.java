 ...
 *
 */
public class SearchCoreStreamHandler extends StreamHandler {
     ...
     */
    public SearchCoreStreamHandler(OutputStream out, Formatter formatter) {
     ...
     * @param formatter Formatter to be used to format the log messages.
     */
    public SearchCoreStreamHandler(OutputStream out, Level level,
            Formatter formatter) {
        super(out, formatter);
        setLevel(level);

...
public class XSLTResponseWriter extends
	...
	@Override
	protected Transformer getTransformer(SolrQueryRequest arg0) throws IOException {
		...
		if (transformer!=null && transformer.getParameter(SOLR_HOME_PARAMETER)==null) {
			transformer.setParameter(SOLR_HOME_PARAMETER, System.getProperty("solr.solr.home") + "/pds");
		}
		return transformer;
	}

package gov.nasa.pds.search.core.test;
...
public class SearchCoreTest {
	...
	protected static Logger log = Logger.getLogger(SearchCoreTest.class.getName());
	
	static {
		log.addHandler(new SearchCoreStreamHandler(System.out,

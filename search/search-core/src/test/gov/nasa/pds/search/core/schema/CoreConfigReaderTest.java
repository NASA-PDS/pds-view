...
public class CoreConfigReaderTest extends SearchCoreTest {
	...
	public static final File PDS_CONFIG_PATH = new File(
			System.getProperty("user.dir") + "/"
					+ TestConstants.CONFIG_DIR_RELATIVE + "pds");
	public static final File PSA_CONFIG_PATH = new File(
			System.getProperty("user.dir") + "/"
					+ TestConstants.CONFIG_DIR_RELATIVE + "psa");
	...
	public void testUnmarshall() {
		try {
			CoreConfigReader.unmarshall(new File(System.getProperty("user.dir")

...
public class TestSolrIndexer extends TestCase {
	...
	public void testSolrIndexer() {
		try {
			File indexDir = new File(TestConstants.CORE_HOME + TestConstants.SERVICE_HOME_RELATIVE + "/index");
			...
			String[] args = { TestConstants.CORE_HOME + TestConstants.SERVICE_HOME_RELATIVE + "/index",
					TestConstants.CORE_HOME + TestConstants.SERVICE_HOME_RELATIVE + "/registry-data" };

The Search Protocol project contains a software library with functionality 
for the protocol interface to the PDS Search Service. The software is 
...
http://pds-cm.jpl.nasa.gov/pds4/search/search-protocol/. If it is not 

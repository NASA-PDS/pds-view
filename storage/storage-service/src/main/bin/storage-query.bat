...
:: Batch file that allows easy execution of the Storage Service Query
:: Tool without the need to set the CLASSPATH or having to type in that long java
:: command (java org.apache.oodt.cas.filemgr.tools.QueryTool ...)

:: Expects the File Manager Query Tool jar file to be in the ../lib directory.
...
"%JAVA_HOME%"\bin\java -Djava.ext.dirs="%FILEMGR_HOME%"\lib org.apache.oodt.cas.filemgr.tools.QueryTool --url %FILEMGR_URL% %*

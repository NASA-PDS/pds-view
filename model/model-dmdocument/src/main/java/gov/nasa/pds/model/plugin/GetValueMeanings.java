...
//		lPVD = new PermValueDefn ("pds:Investigation_Area/pds:Internal_Reference.reference_type.bundle_to_investigation", "bundle_to_investigation", "The bundle is associated to an investigation"); masterValueMeaningMap.put(lPVD.identifier, lPVD);
		...
		lPVD = new PermValueDefn ("pds:Product_Collection/pds:Reference_List/pds:Internal_Reference.reference_type.collection_to_associate", "collection_to_associate", "The collection is associated to product"); masterValueMeaningMap.put(lPVD.identifier, lPVD);
		...
		lPVD = new PermValueDefn ("pds:Product_Bundle/pds:Reference_List/pds:Internal_Reference.reference_type.bundle_to_associate", "bundle_to_associate", "The bundle is associated to product"); masterValueMeaningMap.put(lPVD.identifier, lPVD); 		
		...
		lPVD = new PermValueDefn ("pds:Product_Document/pds:Reference_List/pds:Internal_Reference.reference_type.document_to_associate", "document_to_associate", "The document is associated to product"); masterValueMeaningMap.put(lPVD.identifier, lPVD);

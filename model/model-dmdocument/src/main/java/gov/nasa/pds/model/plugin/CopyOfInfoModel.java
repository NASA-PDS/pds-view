 ...
 */
public abstract class CopyOfInfoModel extends Object {
...
***********************************************************************************************************/
	...
	*/
	...
	/*		if (InfoModel.fundamentalStructures.contains(lName))
		...
		for (Iterator <String> i = CopyOfInfoModel.fundamentalStructures.iterator(); i.hasNext();) {
...
//									lVal = lVal + ".DUP";
	...
	public void getCDDECIndexes () {
		...
		for (Iterator<AttrDefn> i = CopyOfInfoModel.masterMOFAttrArr.iterator(); i.hasNext();) {
			AttrDefn lAttr = (AttrDefn) i.next();
...
// 	*** Note that the Identifier in the MAP is not the identifier in the Attribute; the class has been set to USER.		
		...
		ArrayList <AttrDefn> lAttrArr = new ArrayList <AttrDefn> (CopyOfInfoModel.userClassAttrIdMap.values());
...
//	schematronRuleArr	
	...
	static void printRuleDebug (int lInt, RuleDefn lRule) {
        ...
        System.out.println("    -------------------------  Let Assignments  -------------------------------");

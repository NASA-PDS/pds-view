<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.2.0.1 - Fri Mar 28 10:32:02 PDT 2014 -->
  <!-- Generated from the PDS4 Information Model Version 1.2.0.1 - System Build 4b -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Band_Bin" role="warning">
      <sch:assert test="name() = 'pds:Band_Bin'">
  ...
  <sch:pattern>
    <sch:rule context="pds:Checksum_Manifest">
      ...
      <sch:assert test="if (pds:record_delimiter) then pds:record_delimiter = ('Carriage-Return Line-Feed') else true()">
        The attribute pds:record_delimiter must be equal to one of the following values 'Carriage-Return Line-Feed'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:DD_Association">
      <sch:assert test="if (pds:reference_type) then pds:reference_type = ('attribute_of', 'component_of', 'parent_of') else true()">
        The attribute pds:reference_type must be equal to one of the following values 'attribute_of', 'component_of', 'parent_of'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:DD_Rule_Statement">
      <sch:assert test="if (pds:rule_type) then pds:rule_type = ('Assert', 'Assert Every', 'Assert If', 'Report') else true()">
  ...
  <sch:pattern>
    <sch:rule context="pds:Data_Set_PDS3/pds:start_date_time" role="warning">
      <sch:assert test="name() = 'pds:Data_Set_PDS3/pds:start_date_time'">
  ...
  <sch:pattern>
    <sch:rule context="pds:Data_Set_PDS3/pds:stop_date_time" role="warning">
      <sch:assert test="name() = 'pds:Data_Set_PDS3/pds:stop_date_time'">
  ...
  <sch:pattern>
    <sch:rule context="pds:Encoded_Binary">
      <sch:assert test="if (pds:encoding_standard_id) then pds:encoding_standard_id = ('CCSDS Space Communications Protocols') else true()">
  ...
  <sch:pattern>
    <sch:rule context="pds:Encoded_Native">
      <sch:assert test="if (pds:encoding_standard_id) then pds:encoding_standard_id = ('SEED 2.4') else true()">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area">
      ...
      <sch:assert test="if (pds:information_model_version) then pds:information_model_version = ('1.2.0.1') else true()">
        The attribute pds:information_model_version must be equal to the value '1.2.0.1'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="/*">
  ...
  <sch:pattern>
    <sch:rule context="pds:Instrument_Host/pds:version_id" role="warning">
      <sch:assert test="name() = 'pds:Instrument_Host/pds:version_id'">
  ...
  <sch:pattern>
    <sch:rule context="pds:Inventory">
      ...
      <sch:assert test="if (pds:field_delimiter) then pds:field_delimiter = ('Comma', 'Horizontal Tab', 'Semicolon', 'Vertical Bar', 'comma', 'horizontal tab', 'semicolon', 'vertical bar') else true()">
  ...
  <sch:pattern>
    <sch:rule context="pds:Node">
      <sch:assert test="if (pds:name) then pds:name = ('Engineering', 'Geosciences', 'Imaging', 'Management', 'Navigation and Ancillary Information Facility', 'Planetary Atmospheres', 'Planetary Plasma Interactions', 'Planetary Rings', 'Planetary Science Archive', 'Radio Science', 'Small Bodies') else true()">
  ...
  <sch:pattern>
    <sch:rule context="pds:PDS_Affiliate">
      ...
      <sch:assert test="if (pds:team_name) then pds:team_name = ('Engineering', 'Geosciences', 'Headquarters', 'Imaging', 'Management', 'National Space Science Data Center', 'Navigation and Ancillary Information Facility', 'Planetary Atmospheres', 'Planetary Plasma Interactions', 'Planetary Rings', 'Radio Science', 'Small Bodies') else true()">
  ...
  <sch:pattern>
    <sch:rule context="pds:Software/pds:version_id" role="warning">
      <sch:assert test="name() = 'pds:Software/pds:version_id'">

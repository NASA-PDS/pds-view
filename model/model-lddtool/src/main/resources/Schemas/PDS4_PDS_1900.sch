<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.9.0.0 - Tue Sep 26 16:46:16 PDT 2017 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.9.0.0')">
        The attribute pds:information_model_version must be equal to the value '1.9.0.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>

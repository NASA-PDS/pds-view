...
public class DBProperties {
	...
	public static void main(final String[] args) throws Exception {
		DBProperties connect = new DBProperties("/Users/jpadams/dev/workspace/2010-workspace/report/profile-setup/src/main/resources/conf");
	...
	public DBProperties(final String path) throws IOException {
		...
		encryptor.setPassword(Globals.CRYPT_PASSWORD);

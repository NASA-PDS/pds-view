...
public class ToolInfo {
	public static final String FILE = "report-mgr.properties";

	public static final String NAME = "report.manager.name";

	public static final String VERSION = "report.manager.version";

	public static final String RELEASE_DATE = "report.manager.date";

	public static final String COPYRIGHT = "report.manager.copyright";

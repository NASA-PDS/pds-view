...
//
// $Id: ToolsOption.java 10981 2012-09-26 22:36:06Z jpadams $
package gov.nasa.pds.report.manager.cli.options;
...
public class ToolsOption extends Option {
	 ...
	 * @param name		Sets the display name of the argument value.
	 * @param type		Sets the data type allowed for this argument.
	 * @param separator	Sets the separator value allowed in between the argument

...
package gov.nasa.pds.report.logging.handler;

import gov.nasa.pds.report.logging.filter.ToolsLogFilter;
 ...
 *
 */
public class PDSFileHandler extends FileHandler {
     ...
     * @throws IOException
     */
    public PDSFileHandler(String file, Formatter formatter)
     ...
     * @throws IOException
     */
    public PDSFileHandler(String file, Level level, Formatter formatter)
    throws SecurityException, IOException {
     ...
     * @throws IOException
     */
    public PDSFileHandler(String file, boolean append, Level level,

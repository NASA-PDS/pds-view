...
public class SawmillDB {
	...
	public void execute(String sawmillHome, String profileName, boolean isNewProfile) throws RSUpdateException, IOException {
		...
		Process pr = null;
		try {
			this.LOG.info("Executing: " + sawmillHome + "/sawmill.cgi -p " + profileName + " -a "+dbOption);
			pr = rt.exec(sawmillHome + "/sawmill.cgi -p " + profileName + " -a " + dbOption);

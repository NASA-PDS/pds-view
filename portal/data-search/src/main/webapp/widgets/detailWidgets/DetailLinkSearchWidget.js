...
AjaxSolr.DetailLinkSearchWidget = AjaxSolr.AbstractTextWidget.extend({
    ...
    init: function () {
        ...
        $(document).on('click', 'a.detailLink', function () {
            ...
            var urlPrefix = "https://pds.jpl.nasa.gov/";
            var url = urlPrefix + product.resLocation;
    ...
    setDetailDiv: function(id){
        ...
        console.log("product", product);
        $("#dsDetailContainer").empty();
        $("#dsDetailContainer").append(this.template(product));
        ...
        if(product.file_name){
          ...
          $("#dsDetailContainer").append(fileListDivHtml);
    ...
    setTitle:function(product){
      $("#dsDetailTitle").empty();
      $("#dsDetailTitle").append('<span style="font-size:175%;vertical-align: middle;">Tool Detail</span>&nbsp;&nbsp;&nbsp;<button id="returnToSearchButtonTop" type="button" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Return To Search</button>');
    },
    ...
    showDetailDiv: function(){
        $( "#dsResult" ).fadeOut(400);
        $( "#dsDetailDiv" ).fadeIn(800);
        $( "#dsSearch" ).fadeOut(400);

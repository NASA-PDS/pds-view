...
insert into target_tools (target, title, description, url, rank) values ('Saturn System', 'OPUS at the Ring-Moon Systems Node', 'Supports New Horizons (LORRI), Cassini (ISS, UVIS, VIMS), and Voyager (ISS), all with enhanced geometric metadata which enables more detailed searches, including surface search constraints for the planet, satellites and rings (e.g., latitudes and longitudes).  Also supports LORRI (MVIC) and HST (ACS,WFC3,WFPC2). Browse and download including calibrated Cassini ISS and Voyager ISS. Links to STScI for HST downloads.', 'https://tools.pds-rings.seti.org/opus#/planet=JUPITER', 2);
...
insert into target_tools (target, title, description, url, rank) values ('Neptune System', 'OPUS at the Ring-Moon Systems Node', 'Supports New Horizons (LORRI) and Voyager (ISS), both with enhanced geometric metadata. Also supports HST (ACS, WFC3, WFPC2). Browse and download including calibrated Voyager ISS. Browse with links to STScI for HST.', 'https://tools.pds-rings.seti.org/opus#/planet=Neptune', 3);

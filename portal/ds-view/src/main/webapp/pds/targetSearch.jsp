...
%>
<HTML><HEAD><TITLE>PDS Target Search</TITLE>
...
function setTargName(selectBox,textValue){
 if (document.postForm.targselect[1].checked){
	...
	filterString = filterString.replace(/\\/g,"\\\\");
   	...
   	filterString = filterString.replace(/\+/g,"\\+");
   	filterString = filterString.replace(/\?/g,"\\?");
   //Then replace * in filter string to match all things
   	filterString = "/^" + filterString.replace(/\*/g,"[\\w|\\W]*") + "$/i";

   	for(var i=0; i < selectBox.options.length; i++){
   		if ((selectBox.options[i].value).match(eval(filterString.toString()))) {
...
function changeSearchSpec()
{
  var frm = document.postForm;
   ...
   if (msnname_sel) {
    ...
    frm.action = '/pds/targetSearch.jsp';
    frm.onSubmit = '';
//  frm.method = 'get';
    frm.submit();
}
...
<FORM action=/servlet/jpl.pds.servlets.TargetQueryServlet id=postForm method=post name=postForm onSubmit="return validateSearchParams()">
                   ...
                   <tr>
                     <td>
                      <table border="0" cellpadding="0" cellspacing="0" width="760">
                        <tr>
                          <td class="pageTitle" align=left><font color="#6F4D0E">Target Search</font>
                          </td>
                          <td align=right color="#6F4D0E" valign=center>
                            <A href="javascript:openWindow('target_search_help.html', 'Result',550,500)">
	            ...
	            <td><img src="/pds/images/spacer.gif" width="5" height="5" border="0"></td>
                   ...
                   <tr bgcolor="#123261">
                            <td align="right" valign="center" height=22>
                              <A href="/pds/targetSearch.jsp"><IMG SRC="/pds/images/btn_reset.gif" BORDER=0></A>
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <tr>
                     <td>
                       ...
                       <%@ include file="/pds/advancedSearchParams_target.jsp" %>
                       <%@ include file="/pds/powerSearchParams_target.jsp" %>
                       </table>
                     </td>
                   </tr>

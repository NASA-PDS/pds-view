<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.3.0.1 - Mon Sep 29 19:28:04 PDT 2014 -->
  <!-- Generated from the PDS4 Information Model Version 1.3.0.1 - System Build 5a -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.3.0.1')">
        The attribute pds:information_model_version must be equal to the value '1.3.0.1'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>

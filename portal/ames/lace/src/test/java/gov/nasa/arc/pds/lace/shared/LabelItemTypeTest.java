...
public class LabelItemTypeTest {
	...
	public void testEquals() {
		...
		type2.setWhitespacePreserved(true);
		assertNotEquals(type1, type2);
		...
		type2 = makeLabelItemType();
		type2.getPatterns().add("[a-z]");
		assertNotEquals(type1, type2);

		type2 = makeLabelItemType();
		type2.setDefaultValue("gorp");
		assertNotEquals(type1, type2);
	}
	...
	private LabelItemType makeLabelItemType() {
		...
		type.setPatterns(new ArrayList<String>());
	...
	public void testDocumentation() {
		LabelItemType type = makeLabelItemType();
		assertNull(type.getDocumentation());

		String doc = "<p>this is the documentation</p>";
		type.setDocumentation(doc);
		assertEquals(type.getDocumentation(), doc);
	}

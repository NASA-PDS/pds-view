...
public class SubstringSuggestOracleTest {
	...
	private MySuggestionProvider provider;

	@BeforeMethod
	public void init() {
		oracle = new SubstringSuggestOracle();
		provider = new MySuggestionProvider();
		oracle.setSuggestionProvider(provider);
	}
	...
	private void addSuggestions() {
		provider.clear();
		provider.addSuggestions(SUGGESTIONS);
	}
	...
	private class MySuggestionProvider implements SuggestionProvider {

		private List<String> suggestions = new ArrayList<String>();

		public void addSuggestions(String... strings) {

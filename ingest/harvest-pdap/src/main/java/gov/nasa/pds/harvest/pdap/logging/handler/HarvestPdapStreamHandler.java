 ...
 *
 */
public class HarvestPdapStreamHandler extends StreamHandler {
   ...
   */
  public HarvestPdapStreamHandler(OutputStream out, Formatter formatter) {
   ...
   * @param formatter Formatter to be used to format the log messages.
   */
  public HarvestPdapStreamHandler(OutputStream out, Level level,
      Formatter formatter) {
    super(out, formatter);
    setLevel(level);
  }

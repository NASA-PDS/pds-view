...
//
// $Id$
package gov.nasa.pds.harvest.pdap.logging.handler;
 ...
 *
 */
public class HarvestPdapFileHandler extends FileHandler {
   ...
   * @throws IOException
   */
  public HarvestPdapFileHandler(String file, Formatter formatter)
   ...
   * @throws IOException
   */
  public HarvestPdapFileHandler(String file, Level level, Formatter formatter)
  throws SecurityException, IOException {
   ...
   * @throws IOException
   */
  public HarvestPdapFileHandler(String file, boolean append, Level level,

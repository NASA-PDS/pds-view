...
public class ToolInfo {
    public static final String FILE = "harvest-pdap.properties";

    public static final String NAME = "harvest-pdap.name";

    public static final String VERSION = "harvest-pdap.version";

    public static final String RELEASE_DATE = "harvest-pdap.date";

    public static final String COPYRIGHT = "harvest-pdap.copyright";

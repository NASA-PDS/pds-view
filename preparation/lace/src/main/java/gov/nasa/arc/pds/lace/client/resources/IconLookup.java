...
public class IconLookup {
	...
	private static final String SCHEMA_0300A_TARGET_NS = "http://pds.nasa.gov/pds4/pds/v03";	
	 ...
	 * @return
	 */
	public String getIconClassName(LabelItemType type) {
		return getIconClassName(type.getElementName(), type.getElementNamespace());
	}
	 ...
	 * @return
	 */
	public String getIconClassName(String name, String nameSpace) {
		String className = COMPLEX_ITEM_TYPE_ICON.get(makeKey(name, nameSpace));		
		if (className == null) {
	...
	private static String makeKey(String name) {
		return makeKey(name, SCHEMA_0300A_TARGET_NS);
	}
	
	private static String makeKey(String name, String nameSpace) {

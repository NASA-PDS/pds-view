<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.2.0.0 - Tue Mar 18 09:57:59 PDT 2014 -->
  <!-- Generated from the PDS4 Information Model Version 1.2.0.0 - System Build 4a -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area">
      ...
      <sch:assert test="if (pds:information_model_version) then pds:information_model_version = ('1.2.0.0') else true()">
        The attribute pds:information_model_version must be equal to the value '1.2.0.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="/*">

<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.3.0.0 - Wed Sep 10 16:23:29 PDT 2014 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:DD_Value_Domain_Full/pds:unit_of_measure_type">
      <sch:assert test=". = ('Units_of_Amount_Of_Substance', 'Units_of_Angle', 'Units_of_Angular_Velocity', 'Units_of_Area', 'Units_of_Frame_Rate', 'Units_of_Frequency', 'Units_of_Length', 'Units_of_Map_Scale', 'Units_of_Mass', 'Units_of_Misc', 'Units_of_None', 'Units_of_Optical_Path_Length', 'Units_of_Pressure', 'Units_of_Radiance', 'Units_of_Rates', 'Units_of_Solid_Angle', 'Units_of_Spectral_Irradiance', 'Units_of_Spectral_Radiance', 'Units_of_Storage', 'Units_of_Temperature', 'Units_of_Time', 'Units_of_Velocity', 'Units_of_Voltage', 'Units_of_Volume', 'Units_of_Wavenumber')">
  ...
  <sch:pattern>
    <sch:rule context="pds:Field_Binary/pds:data_type">
      <sch:assert test=". = ('ASCII_AnyURI', 'ASCII_Boolean', 'ASCII_DOI', 'ASCII_Date', 'ASCII_Date_DOY', 'ASCII_Date_Time', 'ASCII_Date_Time_DOY', 'ASCII_Date_Time_UTC', 'ASCII_Date_Time_YMD', 'ASCII_Date_YMD', 'ASCII_Directory_Path_Name', 'ASCII_File_Name', 'ASCII_File_Specification_Name', 'ASCII_Integer', 'ASCII_LID', 'ASCII_LIDVID', 'ASCII_LIDVID_LID', 'ASCII_MD5_Checksum', 'ASCII_NonNegative_Integer', 'ASCII_Numeric_Base16', 'ASCII_Numeric_Base2', 'ASCII_Numeric_Base8', 'ASCII_Real', 'ASCII_String', 'ASCII_Time', 'ASCII_VID', 'ComplexLSB16', 'ComplexLSB8', 'ComplexMSB16', 'ComplexMSB8', 'IEEE754LSBDouble', 'IEEE754LSBSingle', 'IEEE754MSBDouble', 'IEEE754MSBSingle', 'SignedBitString', 'SignedByte', 'SignedLSB2', 'SignedLSB4', 'SignedLSB8', 'SignedMSB2', 'SignedMSB4', 'SignedMSB8', 'UTF8_String', 'UnsignedBitString', 'UnsignedByte', 'UnsignedLSB2', 'UnsignedLSB4', 'UnsignedLSB8', 'UnsignedMSB2', 'UnsignedMSB4', 'UnsignedMSB8')">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.3.0.0')">
        The attribute pds:information_model_version must be equal to the value '1.3.0.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Units_of_Radiance" role="warning">
      <sch:assert test="pds:unit_id != 'W*m**-2*sr**-1'">
        The value W*m**-2*sr**-1 for attribute Units_of_Radiance.unit_id is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Units_of_Spectral_Irradiance" role="warning">
      <sch:assert test="pds:unit_id != 'W*m**-2*Hz**-1'">
        The value W*m**-2*Hz**-1 for attribute Units_of_Spectral_Irradiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'W*m**-2*nm**-1'">
        The value W*m**-2*nm**-1 for attribute Units_of_Spectral_Irradiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'W*m**-3'">
        The value W*m**-3 for attribute Units_of_Spectral_Irradiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'uW*cm**-2*um**-1'">
        The value uW*cm**-2*um**-1 for attribute Units_of_Spectral_Irradiance.unit_id is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Units_of_Spectral_Radiance" role="warning">
      <sch:assert test="pds:unit_id != 'W*m**-2*sr**-1*Hz**-1'">
        The value W*m**-2*sr**-1*Hz**-1 for attribute Units_of_Spectral_Radiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'W*m**-2*sr**-1*nm**-1'">
        The value W*m**-2*sr**-1*nm**-1 for attribute Units_of_Spectral_Radiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'W*m**-2*sr**-1*um**-1'">
        The value W*m**-2*sr**-1*um**-1 for attribute Units_of_Spectral_Radiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'W*m**-3*sr**-1'">
        The value W*m**-3*sr**-1 for attribute Units_of_Spectral_Radiance.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'uW*cm**-2*sr**-1*um**-1'">
        The value uW*cm**-2*sr**-1*um**-1 for attribute Units_of_Spectral_Radiance.unit_id is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Units_of_Wavenumber" role="warning">
      <sch:assert test="pds:unit_id != 'cm**-1'">
        The value cm**-1 for attribute Units_of_Wavenumber.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'm**-1'">
        The value m**-1 for attribute Units_of_Wavenumber.unit_id is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:unit_id != 'nm**-1'">
        The value nm**-1 for attribute Units_of_Wavenumber.unit_id is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>

<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.1.0.1 - Tue Nov 12 19:02:23 PST 2013 -->
  <!-- Generated from the PDS4 Information Model Version 1.1.0.1 - System Build 4a -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Discipline_Facets">
  ...
  <sch:pattern>
    <sch:rule context="pds:Group_Facet1">
      <sch:assert test="if (pds:facet1) then pds:facet1 = ('2D', 'Color', 'Color Movie', 'Dust Study', 'Dynamical Properties', 'Electric', 'Electrons', 'Gas Study', 'Grayscale', 'Historical Reference', 'Ions', 'Lightcurve', 'Linear', 'Magnetic', 'Meteoritics', 'Meteorology', 'Movie', 'Neutrals', 'Photometry', 'Physical Properties', 'Polarimetry', 'Production Rates', 'Ring Compositional Map', 'Ring Occultation Profile', 'Ring Thermal Map', 'Satellite Astrometry', 'Shape Model', 'Spectral Cube', 'Spectral Image', 'Structure', 'Tabulated', 'Taxonomy') else true()">
        The attribute pds:facet1 must be equal to one of the following values '2D', 'Color', 'Color Movie', 'Dust Study', 'Dynamical Properties', 'Electric', 'Electrons', 'Gas Study', 'Grayscale', 'Historical Reference', 'Ions', 'Lightcurve', 'Linear', 'Magnetic', 'Meteoritics', 'Meteorology', 'Movie', 'Neutrals', 'Photometry', 'Physical Properties', 'Polarimetry', 'Production Rates', 'Ring Compositional Map', 'Ring Occultation Profile', 'Ring Thermal Map', 'Satellite Astrometry', 'Shape Model', 'Spectral Cube', 'Spectral Image', 'Structure', 'Tabulated', 'Taxonomy'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Group_Facet2">
      <sch:assert test="if (pds:facet2) then pds:facet2 = ('Background', 'Cosmic Ray', 'Energetic', 'Plasma', 'Solar Energetic', 'Waves') else true()">
        The attribute pds:facet2 must be equal to one of the following values 'Background', 'Cosmic Ray', 'Energetic', 'Plasma', 'Solar Energetic', 'Waves'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area">
      ...
      <sch:assert test="if (pds:information_model_version) then pds:information_model_version = ('1.1.0.1') else true()">
        The attribute pds:information_model_version must be equal to the value '1.1.0.1'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="/*">

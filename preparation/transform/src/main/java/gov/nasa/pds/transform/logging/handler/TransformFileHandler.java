 ...
 *
 */
public class TransformFileHandler extends FileHandler {
     ...
     * @throws IOException
     */
    public TransformFileHandler(String file, Formatter formatter)
     ...
     * @throws IOException
     */
    public TransformFileHandler(String file, Level level, Formatter formatter)
    throws SecurityException, IOException {
     ...
     * @throws IOException
     */
    public TransformFileHandler(String file, boolean append, Level level,

    ...
    extends Product
{
    ...
    /**
     * Gets the value of the fileAreaBrowses property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fileAreaBrowses property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFileAreaBrowses().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<FileAreaBrowse> getFileAreaBrowses() {
        if (fileAreaBrowses == null) {
            fileAreaBrowses = new ArrayList<FileAreaBrowse>();
        }

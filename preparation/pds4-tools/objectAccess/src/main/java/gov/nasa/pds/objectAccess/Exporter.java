...
public interface Exporter<T> {
	 ...
	 * @param exportType
	 */
	public abstract void setExportType(String exportType);
	 ...
	 */
	public abstract void setObjectProvider(ObjectProvider provider);
	 ...
	 */
	public abstract void setObservationalFileArea(FileAreaObservational fileAreaObs);
	 ...
	 * @throws IOException
	 */
	public abstract void convert(T object, OutputStream outputStream) throws IOException;
	 ...
	 * @throws IOException
	 */
	public abstract void convert(OutputStream outputStream, int objectIndex) throws IOException;

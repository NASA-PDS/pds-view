The Registry Core is a software library for accessing the PDS Registry 
Service. The software is packaged in a JAR file.
...
http://pds-cm.jpl.nasa.gov/2010/registry/registry-core/. If it is not 

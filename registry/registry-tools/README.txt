The Registry Tools project contains software for interacting with the 
Registry Service.
...
http://pds-cm.jpl.nasa.gov/pds4/registry/registry-tools. If it is not 
accessible, you can execute the "mvn site:run" command and 

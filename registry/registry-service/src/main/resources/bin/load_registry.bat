...
curl -X POST -H "Content-type:application/xml" -v -d @../conf/nodeRegistryObject.xml "%REGISTRY_SERVICE%/registry/schemes/urn:registry:classificationScheme:ObjectType/nodes"

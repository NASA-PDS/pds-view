...
curl -X POST -H "Content-type:application/xml" -v -d @../conf/registryAssociationTypeScheme.xml "%REGISTRY_SERVICE%/configure?name=Core+Associations&description=This+configures+the+core+set+of+associations"

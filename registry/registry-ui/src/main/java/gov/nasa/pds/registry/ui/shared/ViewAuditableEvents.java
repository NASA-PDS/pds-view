...
/**
 * The display container for events. Necessary to be able to use an object
 ...
 * @author hyunlee
 */
public class ViewAuditableEvents extends ArrayList<ViewAuditableEvent> implements
		IsSerializable {

...
/**
 * The display container for package. Necessary to be able to use an object
 ...
 * @author hyunlee
 */
public class ViewRegistryPackages extends ArrayList<ViewRegistryPackage> implements
		IsSerializable {
